...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 출력할 데이터 생성
        array = new ArrayList<>();
        ProductVO vo = new ProductVO(1, "고추참치", R.drawable.dongwon, 1200);
        array.add(vo);
        vo = new ProductVO(2, "챠오츄르", R.drawable.ciao, 700);
        array.add(vo);
        vo = new ProductVO(3, "로얄캐닌", R.drawable.royal, 22000);
        array.add(vo);
        vo = new ProductVO(4, "마약방석", R.drawable.bangbang, 17000);
        array.add(vo);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(MainActivity.this, vo.getName()+"을(를) 주문합니당", Toast.LENGTH_SHORT).show();
                }
            });


            // 각 아이템 클릭했을 때 Ac3로 가게 만들자구
